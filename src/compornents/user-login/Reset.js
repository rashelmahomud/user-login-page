        ...
        <div >
            <div className="flex items-center min-h-screen p-4  lg:justify-center">
                ...
                >
                    ...
                    >
                        <img className=' ' src='https://i.postimg.cc/cH3kCCbJ/blue-user-icon-symbol-website-admin-social-login-element-concept-white-background-3d-rendering-remov.png' alt="image" />
                    </div>
